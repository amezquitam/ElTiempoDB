...
BEGIN
  ...
  PERFORM CREAR_ARTICULO(1, 'Estudio revela aumento de la contaminación en la ciudad',	'2023-05-21',	'Un estudio realizado por expertos en medio ambiente ha revelado un preocupante aumento de los nivele...',	'Impacto en la salud de los ciudadanos',	'imagen2.jpg',	'0');
  PERFORM CREAR_ARTICULO(2, 'Entrevista exclusiva con reconocido cineasta',	'2023-05-20',	'En una entrevista exclusiva, el reconocido cineasta habla sobre su más reciente película, sus inspiraci...',	'Detrás de cámaras de su último éxito',	'imagen3.jpg',	'1');
  PERFORM CREAR_ARTICULO(3, 'Nuevas investigaciones arrojan luz sobre caso de corrupción',	'2023-05-19',	'Las últimas investigaciones sobre el caso de corrupción que ha sacudido al país revelan nuevos detalles ...',	'Implicaciones políticas en juego',	'imagen4.jpg',	'0');
  PERFORM CREAR_ARTICULO(4, 'Expertos advierten sobre los peligros del uso excesivo de las redes sociales',	'2023-05-18',	'Diversos expertos en psicología y sociología han alertado sobre los riesgos para la salud mental y las re...',	'Impacto en la sociedad actual',	'imagen5.jpg',	'1');
  PERFORM CREAR_ARTICULO(5, 'Equipo local se prepara para el partido de semifinales',	'2023-05-17',	'El equipo de fútbol local se encuentra entrenando arduamente para el partido de semifinales que se llevará...',	'Rumbo a la gran final',	'imagen6.jpg',	'0');
  PERFORM CREAR_ARTICULO(6, 'Descubren nuevos restos arqueológicos en yacimiento histórico',	'2023-05-16',	'Durante las excavaciones en un yacimiento histórico, se han encontrado nuevos restos que podrían arrojar n...',	'Reescribiendo la historia',	'imagen7.jpg',	'1');
  PERFORM CREAR_ARTICULO(7, 'El presidente anuncia nuevas medidas económicas', '2023-05-22', 'El presidente anunció hoy en conferencia de prensa una serie de medidas económicas para impulsar...',	'Impulso al sector empresarial',	'imagen1.jpg',	'1');
  PERFORM CREAR_ARTICULO(8, 'Tras atroz crimen de disidencias, paz total de Petro enfrenta otro desafío: ¿qué sigue?', '2023-05-22', 'El proyecto de "paz total" del gobierno del presidente Gustavo Petro vive sus horas más críticas luego del crimen perpetrado por el llamado "Estado Mayor Central" de las Farc (Emc-Farc).',	'El Gobierno suspendió parcialmente cese del fuego. ¿Qué significa esta decisión? ¿Qué viene ahora?',	'imagen8.jpg',	'1');
  PERFORM CREAR_ARTICULO(9, 'Gustavo Petro habla sobre trino de niños desaparecidos en Guaviare: "Ni lo escribí"', '2023-05-22', 'El pasado 17 de mayo, el presidente Gustavo Petro anunció por medio de su cuenta en Twitter que los niños desaparecidos tras el accidente de la avioneta en las selvas que conectan a Caquetá con Guaviare habían sido encontrados con vida. Sin embargo, el trino fue eliminado horas después y el mandatario tuvo que excusarse por dar una información errónea al país."He decidido borrar el trino debido a que la información entregada por el ICBF no ha podido ser confirmada. Lamento lo sucedido".',	'El presidente se refirió al trino donde aseguraba que los cuatro niños habían sido encontrados.',	'imagen9.jpg',	'0');
  PERFORM CREAR_ARTICULO(10, '"Nuestra relación de seguridad con Colombia es muy estrecha": Jefa Southcom de EE. UU.', '2023-05-22', 'La jefa del Comando Sur de Estados Unidos, la general Laura Richardson, llegó a Bogotá el domingo para una visita de tres días que incluyó un encuentro con el presidente colombiano, Gustavo Petro.',	'La general Laura Richardson, jefa del Comando Sur, habló con EL TIEMPO de su visita a Colombia.',	'imagen10.jpg',	'1');
  PERFORM CREAR_ARTICULO(11, 'China aprueba la compra de Activision Blizzard por parte de Microsoft', '2023-05-22', 'Microsoft aseguró el viernes pasado que China aprobó "incondicionalmente" su plan para comprar la compañía de videojuegos Activision Blizzard, en momentos en los que el acuerdo aún enfrenta una fuerte oposición antimonopolio en los Estados Unidos y el Reino Unido',	'Un portavoz de Microsoft aseguró que China es el país número 37 que apoya la adquisición.',	'imagen11.jpg',	'0');
  PERFORM CREAR_ARTICULO(12, 'Hallan restos arqueológicos en antigua ciudad romana', '2023-05-22', 'Durante las excavaciones en la antigua ciudad romana de Pompeya,ueólogos descubrieron importantes restos que revelan detalles sobre la vida en la época.', 'Descubrimiento histórico en Pompeya', 'pompeya.jpg', '1');
  PERFORM CREAR_ARTICULO(13, 'Científicos encuentran nueva especie de dinosaurio en Patagonia', '2023-05-21', 'Un equipo de paleontólogos descubrió los restos de un dinosaurio hasta ahora desconocido en la región de la Patagonia. El hallazgo podría proporcionar nuevas pistas sobre la evolución de estas criaturas prehistóricas.', 'Nueva especie de dinosaurio en la Patagonia', 'patagonia.jpg', '0');
  PERFORM CREAR_ARTICULO(14, 'Expertos advierten sobre el aumento de la contaminación en grandes ciudades', '2023-05-20', 'Un informe elaborado por especialistas en medio ambiente alerta sobre el creciente problema de la contaminación en las grandes ciudades. Se destacan los efectos negativos en la salud de los habitantes y la urgencia de tomar medidas para reducir la emisión de contaminantes.', 'Contaminación en las ciudades', 'contaminacion.jpg', '1');
  PERFORM CREAR_ARTICULO(15,'Descubren posible cura para una enfermedad rara', '2023-05-19', 'Investigadores han encontrado indicios prometedores sobre una posible cura para una enfermedad rara que afecta a un pequeño grupo de pacientes. Los resultados de los ensayos clínicos son alentadores.', 'Avances en el tratamiento de enfermedad rara', 'enfermedad_rara.jpg', '0');
  PERFORM CREAR_ARTICULO(16,'Lanzamiento de nuevo satélite para la exploración espacial', '2023-05-18', 'Hoy se llevó a cabo el exitoso lanzamiento de un nuevo satélite destinado a la exploración espacial. El dispositivo cuenta con tecnología de vanguardia y se espera que proporcione datos importantes sobre nuestro universo.', 'Nueva misión espacial', 'satelite.jpg', '0');
  ...
  PERFORM CREAR_ARTICULO(6,'Descubren nueva especie de insecto en selva amazónica','2023-05-07','Un equipo de biólogos ha descubierto una nueva especie de insecto en la selva amazónica. Este hallazgo demuestra la increíble diversidad biológica que aún queda por explorar.','Nueva especie de insecto en la Amazonía','insecto_amazonia.jpg','1');
  PERFORM CREAR_ARTICULO(7,'Avance en la tecnología de vehículos eléctricos','2023-05-06','Empresas automotrices anuncian un importante avance en la tecnología de vehículos eléctricos. Se espera que estos avances impulsen la adopción masiva de vehículos eléctricos y contribuyan a la reducción de emisiones contaminantes.','Tecnología de vehículos eléctricos','vehiculo_electrico.jpg','0');
